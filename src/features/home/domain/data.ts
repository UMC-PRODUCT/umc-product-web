...
export const projectsData: Record<string, Array<Project>> = {
  '7': [
    {
      image: '/src/shared/assets/project/7th/DOG_MODE.webp',
      title: '이거먹자',
      description: '나만을 위한 AI 영양사 ',
      tech: [],
    },
    {
      image: '/src/shared/assets/project/7th/CatchY.png',
      title: 'Catch:Y',
      description: '특별한 하루를 위해, 취향을 Catch:y',
      tech: ['iOS', 'SpringBoot'],
    },
    {
      image: '/src/shared/assets/project/7th/MEME_SPHERE.png',
      title: '밈스피어',
      description: '세상의 모든 밈코인을 한 곳에서',
      tech: [],
    },
    {
      image: '/src/shared/assets/project/7th/DDADDA.webp',
      title: '따따',
      description: '어디서든 기록 가능한 위치기반 추억 기록 서비스',
      tech: ['Android', 'SpringBoot'],
    },
    {
      image: '/src/shared/assets/project/7th/HRR.webp',
      title: '흐르르',
      description: '흐르르 따라 흐르는 나의 성장',
      tech: ['Android', 'Node.js'],
    },
    {
      image: '/src/shared/assets/project/7th/Ttt.png',
      title: 'Ttt',
      description: '가벼운 마음으로 독서를 시작할 수 있도록, Ttt',
      tech: [],
    },
    {
      image: '/src/shared/assets/project/7th/Archive.webp',
      title: 'Archive',
      description: '음악으로 시간의 흐름을 만나다',
      tech: ['iOS', 'Node.js'],
    },
    {
      image: '/src/shared/assets/project/7th/Edison.png',
      title: 'Edison',
      description: '당신의 아이디어, 터지지 않는 버블에 보관하세요',
      tech: [],
    },
    {
      image: '/src/shared/assets/project/7th/GROAIT.webp',
      title: '그로우잇',
      description: '음성 기반 AI로 대화하며 일기와 마음챙김 챌린지를 통해 정신 건강을 관리하는 앱',
      tech: ['iOS', 'SpringBoot'],
    },
    {
      image: '/src/shared/assets/project/7th/HOME_MASTER.webp',
      title: 'HOME MASTER',
  ...
  '8': [
    {
      image: '/src/shared/assets/project/8th/HaRu.png',
      title: 'Haru',
      description: '소규모 팀을 위한 All-In-One 운영 관리 플랫폼',
      tech: ['Web', 'Spring Boot'],
    },
    {
      image: '/src/shared/assets/project/8th/BaekHo.png',
      title: '백호',
      description: '정보는 모으고 목표는 사냥하는 프로젝트 관리 툴',
      tech: ['Web', 'SpringBoot'],
    },
    {
      image: '/src/shared/assets/project/8th/Divary.png',
      title: 'Divary',
      description: '다이버를 위한 다이어리',
      tech: [],
    },
    {
      image: '/src/shared/assets/project/8th/PerfuOnMe.webp',
      title: '퍼퓨온미',
      description: '나만의 향기를 찾아주는 서비스',
      tech: [],
    },
    {
      image: '/src/shared/assets/project/8th/Teamie.webp',
      title: 'Teamie',
      description: '나의 팀워크가 모이는 곳',
      tech: [],
    },
    {
      image: '/src/shared/assets/project/8th/Coffect.png',
      title: 'Coffect',
      description: '우리의 만남이 맺어갈 영향력',
      tech: ['Web', 'Node.js'],
    },
    {
      image: '/src/shared/assets/project/8th/ChaekMo.png',
      title: '책모',
      description: '독서 모임의 처음부터 끝까지',
      tech: [],
    },
    {
      image: '/src/shared/assets/project/8th/Channeling.png',
      title: '채널링',
      description: '유튜버의 AI 전략 파트너',
      tech: ['Web', 'SpringBoot'],
    },
    {
      image: '/src/shared/assets/project/8th/OhMaeChu.png',
      title: '오메추',
